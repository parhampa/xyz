...
<!DOCTYPE html>
<html>
<title>تعریف واحد اندازه گیری</title>
<meta charset="UTF-8">
...
<div class="w3-main" style="margin-right:300px;margin-top:43px;">
    ...
    <header class="w3-container" style="padding-top:22px;">
        <h5><b><i class="fa fa-dashboard"></i>تعریف واحد اندازه گیری</b></h5>
    </header>
    <div class="w3-white w3-padding-large w3-margin w3-round-medium w3-right" style="width: 80%;">
        <?php
        $fm = new makeform();
        $fm->set_tbl_key("vahed", "id", 1);
        $fm->CSRF_token();

        $fm->fast_string_input("عنوان واحد اندازه گیری", "title", "title", 1, 1, 1);
